function [im_nordic,gfactor]=NORDIC_imComplex(imcomp,ARG)
% fMRI
% imcomp : 4D complex matrix [3D physical x time]
%  ARG.temporal_phase=1;
%  ARG.phase_filter_width=10;
%  [im_nordic,gfactor]=NORDIC_imComplex(imcomp,ARG)
%
% dMRI
% imcomp : 4D complex matrix [3D phyical x ]
