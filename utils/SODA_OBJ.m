    ...
    methods
        ...
        function obj = extract(obj,mrprot)
            ...
            for cSlice =1:obj.NSlices
                ...
                %% Determine dimension
                if(strcmp(mrprot.MeasYaps.sKSpace.ucDimension,'0x2') || all(mrprot.MeasYaps.sKSpace.ucDimension==2))  % 2D
                    obj.Dim = 2;
                elseif(strcmp(mrprot.MeasYaps.sKSpace.ucDimension,'0x4') ||all(mrprot.MeasYaps.sKSpace.ucDimension==4)) % 3D
                    obj.Dim = 3;
                end                
                ...
                if(strcmp(mrprot.MeasYaps.sKSpace.ucDimension,'0x4')||all(mrprot.MeasYaps.sKSpace.ucDimension==4))  % 3D
                    obj.PixelSizeSlice   = mrprot.MeasYaps.sSliceArray.asSlice{cSlice}.dThickness/mrprot.MeasYaps.sKSpace.lPartitions;
                elseif(strcmp(mrprot.MeasYaps.sKSpace.ucDimension,'0x2') || all(mrprot.MeasYaps.sKSpace.ucDimension==2)) % 2D
